...
CHOREOGRAPHY = [
   ...
   # (3.5,   "DANCE_BEG_WAVE",         "Intro",     "Curious moon-gazing wave on Am"),
    ...
    # ── CHORUS 1 (0:20 – 0:52) ──────────────────────────────────────────
    (20.5,  "DANCE_ROLL_SLOW",           "Chorus 1",  "Moonlight ripple — C"),
    (21.5,  "DANCE_CHASSIS_BREATHE",      "Chorus 1",  "Swaying look up to the moon — Am"),
    (23.5,  "DANCE_ROLL_SLOW",          "Chorus 1",  "Open up, display — F"),
    (23.8,  "DANCE_PEACOCK",           "Chorus 1",  "Cascade back — C"),
    (27.5,  "DANCE_ROLL",             "Chorus 1",  "Gentle roll on G"),
    ...
    (39.5,  "DANCE_BELLY_CRAWL",           "Chorus 1",  "Moonlight ripple — C"),
    (42.0,  "DANCE_WAVE",             "Chorus 1",  "Bridge into verse"),
    (46.5,  "DANCE_PEACOCK",          "Chorus 1",  "Open up, display — F"),
    ...
    (55.5,  "DANCE_BEG_WAVE",           "Verse 1",   "Wahina kala — Em, small circle"),
